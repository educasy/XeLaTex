...
\usepackage[top=1in,bottom=1in,outer=2in,inner=1.2in,heightrounded,marginparwidth=1in,marginparsep=.7in]{geometry}
% --------- Dummy Text -----------
\usepackage{lipsum}
...
\usepackage{tikz}
%\special{papersize=\the\paperwidth,\the\paperheight} % ตั้งหน้ากระดาษ สำหรับ DVI & PS Way
%\usepackage{auto-pst-pdf,pst-barcode} % พิมพ์ QR Code ได้
\pagestyle{fancy}
...
\marginnote{\includegraphics{p000001v2.pdf}}[-2in]
\marginnote{\includegraphics{p000002v2.pdf}}[-0.5in]
\marginnote{\includegraphics{p000003v2.pdf}}[1in]
\marginnote{\includegraphics{p000004v2.pdf}}[2.5in]
...
\marginnote{\includegraphics{p000005v2.pdf}}[-8.7in]
\marginnote{\includegraphics{p000006v2.pdf}}[-7.2in]
